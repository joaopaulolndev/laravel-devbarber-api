...
return [
    ...
    */
    ...
    "telefonefixo"         => ":attribute deve ser uma telefone válido com DDD, por exemplo: (11) 5555-5555",
    "telefonecelular"      => ":attribute deve ser uma telefone válido com DDD (11) 55555-5555",
    'between'              => [
    ...
    'mobile_phone'         => 'O campo :attribute não é um número válido.',
    'phone'                => 'O campo :attribute não é um número válido.',
    'cpf_cnpj'             => 'O campo :attribute ou CNPJ não é um número válido.',
    /*
    |--------------------------------------------------------------------------
